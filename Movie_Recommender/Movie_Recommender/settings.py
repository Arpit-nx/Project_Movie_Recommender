...
SECRET_KEY = 'django-insecure-7o)aoow8upgp3k7wzj-&aqr^f-5p(z^hu2w@oaoe%7-jx)uyxw'
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.ngrok-free.app',  # Matches all ngrok domains
    'http://*.ngrok-free.app',   # Matches all ngrok domains over HTTP
    'http://localhost:8000',      # Add localhost for development
    'https://localhost:8000',     # Add localhost for HTTPS development
]
